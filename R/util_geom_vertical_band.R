...
GeomVerticalBand <- ggproto("GeomVerticalBand", Geom,
...
#'
geom_vertical_band <- function(xmin, xmax,
                               label_y = 0.5, label = "",
                               fill = "gray",alpha = 0.2,
                               label_color = "black",
                               mapping = NULL,
...
ggplot(df, aes(x, y)) +
  geom_line() +
  geom_vertical_band(xmin = 3, xmax = 5, label_y = 0, label = "Band 1", fill = "blue", alpha = 0.1,label_color = "green") +
  geom_vertical_band(xmin = 7, xmax = 9, label_y = 1, label = "Band 2", fill = "red", alpha = 0.1,color = "black")
